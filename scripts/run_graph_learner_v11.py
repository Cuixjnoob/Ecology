...
SEEDS_TEST = SEEDS[:5]
LAM_SPARSE_GL = 0.05  # v1=0.01 (too much), v2=0 (too little), v3=0.001
...
def make_model_gl(N, cfg, device):
    return CVHI_Residual(
        ...
        use_G_field=True, use_graph_learner=True, gl_mode='hard_concrete', gl_renorm_strength=0.3, gl_replace_attn=False,
...
def main():
    ...
    out_dir = Path("runs/graph_learner_v11")
